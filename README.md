...
```bash
# Install (macOS)
brew install trench-tool/trench

# Or download binary
curl -L https://github.com/trench-tool/trench/releases/latest/download/trench-darwin-arm64 -o trench
chmod +x trench
...
| `authentic` | Authentic personal voice - raw, honest |
...
```bash
git clone https://github.com/trench-tool/trench
cd trench
bun install
